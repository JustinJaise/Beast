...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('💠 GᏒԾUᎮ 💠', url='https://t.me/MalayalamRocckers')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton(' 𝙶𝚛𝚘𝚞𝚙 ', url='https://t.me/MalayalamRocckers')
            ],[
            InlineKeyboardButton(' 𝙾𝚠𝚗𝚎𝚛 ', url='https://t.me/Master_Brain1'),
            InlineKeyboardButton(' 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 ', url='https://t.me/TamilRockerssk')
        ]]  
        reply_markup = InlineKeyboardMarkup(buttons)
